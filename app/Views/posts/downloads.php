  ...
  <body style="background-color: rgb(69, 95, 192);">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 170px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="http://localhost:8080/PostController/downloads" class="nav-link text-white">
              下載專區
            </a>
          </li>
          <li>
      ...
      <div class="adjust" >
        下載專區
        <br>
        <a href="downloadFile?item=113a_signdata_dataformat_20230109.pdf" style="color:red">112申請入學集體報名系統-報名資料檔案格式(APPLY.txt)</a>
        <br>
        <a href="downloadFile?item=113a_stu_signdata_survey_20230109.doc" style="color:red">112申請入學集體報名考生報名資料調查表(本表僅供參加學校集體報名考生使用)</a>
      </div>
